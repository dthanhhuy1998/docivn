<header class="main-header">
    ...
    <span class="logo-mini"><b>DC</b>P</span>
    <!-- logo for regular state and mobile devices -->
    <span class="logo-lg">Quản trị DOCI Perfume</span>
    </a>
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown messages-menu">
                    ...
                    <ul class="dropdown-menu">
                        <li class="header">Đăng ký nhận tin</li>
                        <li>
                        ...
                        <li class="footer"><a href="#">Xem tất cả tin</a></li>
                    </ul>
                </li>
                ...
                <li class="dropdown notifications-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="footer"><a href="#">Xem tất cả thông báo</a></li>
                    </ul>
                </li>
                ...
                <li class="dropdown tasks-menu">
                    ...
                    <ul class="dropdown-menu">
                        <li class="header">Tác vụ hôm nay</li>
                        <li>
                            <!-- inner menu: contains the actual data -->
                            <ul class="menu">
                            <li><!-- Task item -->
                        ...
                        <li class="footer">
                            <a href="#">Xem tất cả tác vụ</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-footer">
                            <div class="pull-left">
                            <a href="{{ route('admin.user.getEdit', [Auth::user()->id]) }}" class="btn btn-default btn-flat">Thông tin</a>
                            </div>
                            <div class="pull-right">
                            <a href="{{ route('admin.logout') }}" class="btn btn-default btn-flat">Đăng xuất</a>
                            </div>
                        </li>
                    </ul>
                </li>
