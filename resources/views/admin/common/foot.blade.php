...
<!-- SweetAlert2 -->
<script src="{{ asset('catalog/assets/view/theme_user/assets/lib/sweetalert2/sweetalert2.min.js') }}"></script>

<script src="{{ asset('admin/assets/dist/js/common.js') }}"></script>
