                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="data">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control textarea" placeholder="Nhập mô tả thể tích thực" rows="3" name="actual_volume_description">{{ $product->actual_volume_description }}</textarea>
                                </div>
                                <div class="form-group">
                                    <label>Vị trí</label>
