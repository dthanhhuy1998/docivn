...
@section('content')
   ...
   <section class="content-header">
    ...
    <section class="content">
        <form action="{{ route('admin.gallery.store') }}" role="form" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-md-12">
                    <div class="btn-group">
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <div class="form-group @error('title') has-error @enderror">
                                <label>Tiêu đề</label>
                                <input type="text" class="form-control" placeholder="Nhập tiêu đề ảnh" value="{{ old('title') }}" name="title">
                                @error('title')<span class="help-block">{{ $message }}</span>@enderror
                            </div>
                            <div class="form-group">
                                <label>Mô tả</label>
                                <textarea name="description" class="form-control textarea" rows="8" placeholder="Mô tả"></textarea>
                            </div>
                            ...
                            <div class="form-group">
                                <label>Thứ tự</label>
                                <input type="number" class="form-control" name="image_priority" />
                            </div>
                            <div class="form-group">
