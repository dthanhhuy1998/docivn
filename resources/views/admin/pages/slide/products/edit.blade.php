   ...
   <!-- Content Header (Page header) -->
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{ route('admin.slide.product.getList') }}"><i class="fa fa-picture-o"></i> Slide</a></li>
    ...
    <section class="content">
        <form action="{{ route('admin.slide.product.postEdit') }}" role="form" method="post" enctype="multipart/form-data">
            @csrf
            <input type="hidden" value="{{ $slide->id }}" name="id">
            <div class="row">
                <div class="col-md-12">
                    <div class="btn-group">
                        <a href="{{ route('admin.slide.product.getList') }}" class="btn btn-default btn-sm mr-1" title="Quay lại"><i class="fa fa-angle-left"></i> Quay lại</a>
                        ...
                        <div class="box-body">
                            <div class="form-group  @error('file') has-error @enderror">
                                ...
                                <div class="preview-image" style="width: 200px; height: auto;">
                                    <img src="@if(!empty($slide->slide_image)) {{ Storage::disk('public')->url($slide->slide_image) }} @else {{ Storage::disk('public')->url('uploads/default.png') }} @endif" alt="Avatar" id="preview">
                                </div>
