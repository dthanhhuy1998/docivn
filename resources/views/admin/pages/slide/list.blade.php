   ...
   <!-- Content Header (Page header) -->
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-12">
                <div class="btn-group">
                    <a href="{{ route('admin.slide.getAdd') }}" class="btn btn-primary btn-sm mr-1" title="Tạo slide mới"><i class="fa fa-plus"></i> Tạo slide mới</a>
                </div>
            </div>
            <div class="col-md-12">
                            ...
                            <tbody>
                                ...
                                @foreach($slides as $slide)
                                    ...
                                    <tr>
                                        ...
                                        <td width="10%">
                                            <a href="{{ route('admin.slide.getEdit', [$slide->id]) }}" class="btn btn-primary btn-sm" title="Chỉnh sửa"><i class="fa fa-edit"></i></a>
                                            <a href="{{ route('admin.slide.getDelete', [$slide->id]) }}" class="btn btn-danger btn-sm" title="Xóa bỏ" onclick="return confirm('Bạn có chắn chắn muốn xóa slide này. Xóa?');"><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
