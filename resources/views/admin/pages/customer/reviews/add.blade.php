...
@section('content')
   ...
   <section class="content-header">
    ...
    <section class="content">
        <form action="{{ route('admin.customer.postAddReview') }}" role="form" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-md-12">
                    <div class="btn-group">
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <div class="form-group @error('crName') has-error @enderror">
                                ...
                                <input type="text" class="form-control" placeholder="Nhập tên khách hàng" value="{{ old('crName') }}" name="crName">
                                @error('crName')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Nhập chức vụ/Vị trí" value="{{ old('crPosition') }}" name="crPosition">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="crText" class="form-control" placeholder="Nhập đánh giá khách hàng" rows="4">{{ old('crText') }}</textarea>
                            </div>
                            <div class="form-group">
