                    ...
                    <div class="footer-middle_inner position-relative text-center">
                        ...
                        <div class="footer-social">
                            <ul class="list-unstyled mb-0">
                                @if(isset($siteConfig['facebook']))
                                    <li>
                                        <a href="{{$siteConfig['facebook']}}" target="_blank"><i class="fab fa-facebook-f"></i></a>
                                    </li>
                                @endif
                                @if(isset($siteConfig['twitter']))
                                    <li>
                                        <a href="{{$siteConfig['twitter']}}" target="_blank"><i class="fab fa-twitter"></i></a>
                                    </li>
                                @endif
                                @if(isset($siteConfig['instagram']))
                                    <li>
                                        <a href="{{$siteConfig['instagram']}}" target="_blank"><i class="fab fa-instagram"></i></a>
                                    </li>
                                @endif
                                @if(isset($siteConfig['tiktok']))
                                    <li>
                                        <a href="{{$siteConfig['tiktok']}}" target="_blank"><i class="fab fa-tiktok"></i></a>
                                    </li>
                                @endif
...
<!-- Chat Zalo Plugin  -->
@if(isset($siteConfig['zalo']))
    <span class="xs-hidden">
        <a href="https://zalo.me/{{$siteConfig['zalo']}}" id="linkzalo" target="_blank" rel="noopener noreferrer"><div id="fcta-zalo-tracking" class="fcta-zalo-mess">
